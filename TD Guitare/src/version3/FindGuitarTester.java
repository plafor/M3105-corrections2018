	...
	public static void main(String[] args) {
		...
		if (!lesGuitars.isEmpty()) {
			...
			for (Guitar uneGuitar : lesGuitars) {
				System.out.println("Erin, you might like this " + uneGuitar.getSpecs().getBuilder() + " " + uneGuitar.getSpecs().getModel()
						+ " " + uneGuitar.getSpecs().getType() + " guitar:\n   " + uneGuitar.getSpecs().getBackWood()
