...
public class FindGuitarTester {
	...
	public static void main(String[] args) {
		...
		Guitar whatErinLikes = new Guitar("", 0.0, Builder.FENDER, "Stratocastor", Type.ELECTRIC, Wood.ALDER,
				Wood.ALDER);
		...
		if (!lesGuitars.isEmpty()) {
			...
			for (Guitar uneGuitar : lesGuitars) {
				System.out.println("Erin, you might like this " + uneGuitar.getBuilder() + " " + uneGuitar.getModel()
						+ " " + uneGuitar.getType() + " guitar:\n   " + uneGuitar.getBackWood()
						+ " back and sides,\n   " + uneGuitar.getTopWood() + " top.\nYou can have it for only $"
						+ uneGuitar.getPrice() + "!");
			}
